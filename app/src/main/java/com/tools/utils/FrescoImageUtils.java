...
//
//    private static FrescoImageUtils mFrecoImageUtis = null;
//
//    private FrescoImageUtils() {
//
//    }
//
//    public static FrescoImageUtils getFrescoImageUtils() {
//        if (mFrecoImageUtis == null) {
//            synchronized (FrescoImageUtils.class) {
//                if (mFrecoImageUtis == null) {
//                    mFrecoImageUtis = new FrescoImageUtils();
//                }
//            }
//        }
//        return mFrecoImageUtis;
//    }

    public FrescoImageUtils(SimpleDraweeView mSimpleDraweeView, Context mContext) {
     ...
     */
    private FrescoImageUtils(LoadImageFrescoBuilder frescoBuilder) {
    ...
    public static class LoadImageFrescoBuilder {
         ...
         * @return
         */
        public FrescoImageUtils build() {
            Log.d("Image", "图片开始加载 viewId=" + this.mSimpleDraweeView.getId() + " url" + this.mUrl);
            ...
            return new FrescoImageUtils(this);
        }
